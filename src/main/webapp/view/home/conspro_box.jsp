						...
						<div class="row">
							...
							<div class="col-md-2 col-sm-6 col-xs-12">
								<div class="small-box bg-aqua">
									<div class="inner">
										<h3>150</h3> <p>On-line members</p>
									</div>
									<div class="icon">
										<i class="fa fa-plug"></i>
									</div>
									<a href="#" class="small-box-footer" onclick="doAjaxGet('');"> More <i class="fa fa-arrow-circle-right"></i></a>
								</div>
							</div>
