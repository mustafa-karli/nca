...
@NoArgsConstructor
@AllArgsConstructor
public class UserAccountOwnerId implements java.io.Serializable {
	...
	public UserAccountOwnerId(String keys) {
		String[] s = keys.split(",");
		this.username = s[0];
		this.personId = Integer.parseInt(s[1]);
		try {
	...
	public String toString() {
		return this.username + "," + this.personId + "," + Labels.dmyDF.format(begda);
	}
}
