...
@NoArgsConstructor
@AllArgsConstructor
public class MaintenanceStepId implements java.io.Serializable {
	...
	public MaintenanceStepId(String keys) {
		String[] s = keys.split(",");
		...
		this.materialTypeId = s[3];
	}

	@Override
	public String toString() {
		return this.materialId + "," + this.serialNo + "," + Labels.dmyDF.format(serviceDate) + "," + this.materialTypeId;
	}
}
