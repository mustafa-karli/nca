...
@NoArgsConstructor
@AllArgsConstructor
public class MaintenanceCounterId implements java.io.Serializable {
	...
	public MaintenanceCounterId(String keys) {
		String[] s = keys.split(",");
		...
		this.counterType = s[3];
	}

	@Override
	public String toString() {
		return this.materialId + "," + this.serialNo + "," + Labels.dmyDF.format(serviceDate) + "," + this.counterType;
	}
}
